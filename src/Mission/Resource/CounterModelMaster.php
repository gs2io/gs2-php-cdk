...
use Gs2Cdk\Mission\Ref\CounterModelMasterRef;

class CounterModelMaster extends CdkResource {
    ...
    public function __construct(
        ...
        parent::__construct("Mission_CounterModelMaster_" . $name);
    ...
    public function getAttrCounterId(): GetAttr {
        return new GetAttr(
            key: "Item.CounterId"
        );
    }
