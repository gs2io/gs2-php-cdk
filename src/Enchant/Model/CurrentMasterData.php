...
class CurrentMasterData extends CdkResource {
    ...
    private array $balanceParameterModels;
    private array $rarityParameterModels;
    ...
    public function properties(
        ...
        if ($this->balanceParameterModels != null) {
            $settings["balanceParameterModels"] = array_map(
                function ($v) {
                    return $v->properties(
                    );
                },
                $this->balanceParameterModels
            );
        }
        if ($this->rarityParameterModels != null) {
            $settings["rarityParameterModels"] = array_map(
                function ($v) {
                    return $v->properties(
                    );
                },
                $this->rarityParameterModels
            );
        }
