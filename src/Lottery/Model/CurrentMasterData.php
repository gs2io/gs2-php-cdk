...
class CurrentMasterData extends CdkResource {
    ...
    private array $lotteryModels;
    private array $prizeTables;
    ...
    public function __construct(
        ...
        parent::__construct(
            "Lottery_CurrentLotteryMaster_" . $namespaceName
        );
    ...
    public function properties(
        ...
        if ($this->lotteryModels != null) {
            $settings["lotteryModels"] = array_map(
                function ($v) {
                    return $v->properties(
                    );
                },
        ...
        if ($this->prizeTables != null) {
            $settings["prizeTables"] = array_map(
                function ($v) {
                    return $v->properties(
                    );
                },
