...
use Gs2Cdk\SerialKey\Ref\CampaignModelMasterRef;

class CampaignModelMaster extends CdkResource {

    public Stack $stack;
    public string $namespaceName;
    public string $name;
    public bool $enableCampaignCode;
    ...
    public function __construct(
        ...
        parent::__construct("SerialKey_CampaignModelMaster_" . $name);
    ...
    public function ref(
        ...
        return new CampaignModelMasterRef(
            ...
            campaignModelName: $this->name,
        );
    }

    public function getAttrCampaignId(): GetAttr {
        return new GetAttr(
            key: "Item.CampaignId"
        );
    }
