...
class ScriptSettingOptions {
    public ?String $triggerScriptId = null;
    public ?ScriptSettingDoneTriggerTargetType $doneTriggerTargetType = null;
    public ?String $doneTriggerScriptId = null;
    public ?String $doneTriggerQueueNamespaceId = null;
    
    public function __construct(
        ?String $triggerScriptId = null,
        ?ScriptSettingDoneTriggerTargetType $doneTriggerTargetType = null,
