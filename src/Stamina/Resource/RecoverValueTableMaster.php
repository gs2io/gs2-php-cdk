...
use Gs2Cdk\Stamina\Ref\RecoverValueTableMasterRef;

class RecoverValueTableMaster extends CdkResource {
    ...
    public function __construct(
        ...
        parent::__construct("Stamina_RecoverValueTableMaster_" . $name);
    ...
    public function ref(
        ...
        return new RecoverValueTableMasterRef(
            ...
            recoverValueTableName: $this->name,
        );
    }

    public function getAttrRecoverValueTableId(): GetAttr {
        return new GetAttr(
            key: "Item.RecoverValueTableId"
        );
    }
}
