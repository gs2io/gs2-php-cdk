...
use Gs2Cdk\Stamina\Ref\MaxStaminaTableMasterRef;

class MaxStaminaTableMaster extends CdkResource {
    ...
    public function __construct(
        ...
        parent::__construct("Stamina_MaxStaminaTableMaster_" . $name);
    ...
    public function ref(
        ...
        return new MaxStaminaTableMasterRef(
            ...
            maxStaminaTableName: $this->name,
        );
    }

    public function getAttrMaxStaminaTableId(): GetAttr {
        return new GetAttr(
            key: "Item.MaxStaminaTableId"
        );
    }
}
