...
use Gs2Cdk\Distributor\Ref\DistributorModelMasterRef;

class DistributorModelMaster extends CdkResource {
    ...
    public function __construct(
        ...
        parent::__construct("Distributor_DistributorModelMaster_" . $name);
    ...
    public function getAttrDistributorModelId(): GetAttr {
        return new GetAttr(
            key: "Item.DistributorModelId"
        );
    }
}
