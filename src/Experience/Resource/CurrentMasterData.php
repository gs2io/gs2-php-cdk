...
class CurrentMasterData extends CdkResource {
     ...
     */
    public array $experienceModels;

    /**
     * array<ExperienceModel> $experienceModels
     */
    public function __construct(
        ...
        parent::__construct("Experience_CurrentExperienceMaster_" . $namespaceName);
    ...
    public function properties(): array {
        return [
            ...
            "Settings" => [
                ...
                "experienceModels" => array_map(fn($v) => $v->properties(), $this->experienceModels),
            ],
        ];
    }
}